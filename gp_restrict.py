        ...
        if condition(height, depth):
            ...
            try:
                ...
                try:
                    ...
                    raise IndexError("The gp.generate function tried to add "                                       "a primitive of type '%s', but there is "                                       "none available." % (type_,), traceback)
        ...
        # Not at the bottom of the tree
            ...
            try:
                ...
                # No terminal fits, either - that's an error
                    ...
                    _, _, traceback = sys.exc_info()
                    raise IndexError("The gp.generate function tried to add "                                       "a terminal of type '%s', but there is "                                       "none available." % (type_,), traceback)
                if isclass(term):
                    term = term()
                expr.append(term)
    #print(len(expr))
